...
echo "<h2>" . $txt1 . "</h2>"; //untuk menampilkan variabel $txt1 dengan value string judul dengan font h2
echo "Study PHP at " . $txt2 . "<br>"; //untuk menampilkan variabel $txt2 dengan value string diikuti syntax pindah baris "<br>"
echo $x + $y; //untuk menampilkan hasil perhitungan variabel $x + $y dengan value integer
