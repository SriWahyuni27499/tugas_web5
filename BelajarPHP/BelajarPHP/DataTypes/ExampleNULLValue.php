...
$x = "Hello world!";  //untuk mendeklarasi variabeel $x ke value string
$x = null;  //untuk mendeklarasi variabeel $x ke value null
var_dump($x);//"var_dump digunakan untuk memanggil syntax dan diikuti dengan $x
