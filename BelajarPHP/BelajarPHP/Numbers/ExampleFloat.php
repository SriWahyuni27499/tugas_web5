...
//  Periksa apakah jenis variabel float 
$x = 10.365; //mendeklarasi variabel $x dengan value integer
var_dump(is_float($x)); // kode program "var_dump" mengembalikan fungsi tipe data dan nilai
