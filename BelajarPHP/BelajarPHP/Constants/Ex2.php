...
// Nama konstan yang peka terhadap huruf besar - kecil
define("GREETING", "Welcome to W3Schools.com!", true);//berfungsi untuk membuat konstant define(name, value, case-insensitive)
